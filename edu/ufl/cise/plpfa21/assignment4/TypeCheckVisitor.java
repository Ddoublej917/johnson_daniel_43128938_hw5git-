...
public class TypeCheckVisitor implements ASTVisitor {
	...
	public Object visitIBinaryExpression(IBinaryExpression n, Object arg) throws Exception {
		...
		if(lType.equals(rType)) {
			...
			// not a legal case
			check(false, n, "Both argument types are not the same in binary expression");
		}
	...
	public Object visitILetStatement(ILetStatement n, Object arg) throws Exception {
		...
		IType eType = e != null ? (IType) e.visit(this, arg) : Type__.undefinedType;
		symtab.enterScope();
		INameDef letName = n.getLocalDef();
		IType declaredType = (IType) letName.visit(this, letName);
		IType inferredType = unifyAndCheck(declaredType, eType, n);
		letName.setType(inferredType);
		IBlock block = n.getBlock();
		block.visit(this, arg);
		symtab.leaveScope();
		return arg;
	...
	public Object visitIReturnStatement(IReturnStatement n, Object arg) throws Exception {
		...
		check(compatibleAssignmentTypes(eType, ((IFunctionDeclaration) arg).getResultType()), n, "incompatible types in assignment statement");
	...
	public Object visitISwitchStatement(ISwitchStatement n, Object arg) throws Exception {
		...
		IType eType = (IType) e.visit(this, arg);
		if(eType.isInt() || eType.isBoolean() || eType.isString()) {
			...
			for (IExpression b : branchExpressions) {
				IType bType = (IType) b.visit(this, arg);
				check(isConstantExpression(b), n, "Branch expression type not constant");
				check(compatibleAssignmentTypes(bType, eType), n, "Incompatible types between switch expression and branch expression");
			}
			...
			check(false, n, "Illegal switch expression type");
		}
